    ...
    <ul class="m-b-0 " >
        <?php $__currentLoopData = $rec->conversation->messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="clearfix">
                ...
                <div class="message my-message"> <?php echo e($message->content); ?> </div>
                <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\reclamation_stage\resources\views/emp/conversation.blade.php ENDPATH**/ ?>