...
<div class="chat" id="chat">
  ...
  <div class="chat-message clearfix">
    ...
    <form method="POST" action="<?php echo e(route('reclamations.etat2', $rec)); ?>">
      ...
      <button type="submit" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir terminer la conversation ?')">Terminer la conversation</button>
  </form>
    <?php if($rec->file !=0): ?>
    <a  target="_blank" href="<?php echo e(route('telecharger', ['nomFichier' => $rec->file])); ?>" class="btn btn-primary">afficher le contenu </a>
    <?php endif; ?>
  </div>
  <?php endif; ?>
</div>
...
<?php /**PATH C:\xampp\htdocs\reclamation_stage_part1\reclamation_stage\resources\views/supervisor/conv.blade.php ENDPATH**/ ?>