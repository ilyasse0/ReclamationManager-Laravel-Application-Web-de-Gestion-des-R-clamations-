...
<?php endif; ?>
<a type="button" href="/traiter" class="btn btn-warning">traiter</a>
<a type="button" href="/nontraiter" class="btn btn-secondary">non traiter</a>
      ...
      <div class="col-md-4 mb-4">
          <div class="card">
              <div class="card-body">
                  ...
                  <p><b>employee :</b><?php echo e($reclamation->employee->first_name); ?>  <?php echo e($reclamation->employee->last_name); ?> </p>
...
<script>
  ...
  <?php /**PATH C:\xampp1\htdocs\save_project\reclamation_stage\resources\views/supervisor/rec.blade.php ENDPATH**/ ?>