    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="getstarted scrollto" href="<?php echo e(route('login')); ?>">Make a Complaint</a></li>
          <?php endif; ?>
...
<section id="hero" class="d-flex align-items-center">
  ...
  </section><!-- End Hero --><?php /**PATH C:\xampp1\htdocs\stage_projet\reclamation\reclamation_stage\resources\views/partials/head.blade.php ENDPATH**/ ?>