...
<li class="clearfix">
  <a  href="<?php echo e(route('recsup',$reclamation)); ?>">
<div class="about">
...
<div class="chat" id="chat">
  <div class="chat-header clearfix">
      <div class="row">
          <div class="col-lg-6">
              ...
              <a href="<?php echo e(route('sidebareSUP')); ?>" class="btn btn-outline-primary" id="baccckbtn">Back</a>  
    ...
    <ul class="m-b-0 " >
        <?php $__currentLoopData = $rec->conversation->messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="clearfix">
                ...
                <div class="message other-message float-right"> <?php echo e($message->content); ?> </div>
                <?php endif; ?>
            </li>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </ul>
  ...
  <div class="chat-message clearfix">
      ...
      <form action="<?php echo e(route('addmsg',[$rec->conversation])); ?>" method="post">
        ...
        <div class="input-group">
          ...
          <div class="input-group-append" id="submit-container" style="display:none">
            <button class="btn btn-outline-secondary" id="btn3" type="submit"><i class="fa fa-send" id="sendbtn2"></i></button>
    ...
    <div class="affichC">
    <form method="POST" action="<?php echo e(route('reclamations.etat2', $rec)); ?>">
      <?php echo csrf_field(); ?>
      <?php echo method_field('PUT'); ?>
      <button id="convEnd" type="submit" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir terminer la conversation ?')">Terminer la conversation</button>
  </form>
    <?php if($rec->file !=0): ?>
    <a id="aficherBtn"  target="_blank" href="<?php echo e(route('telecharger', ['nomFichier' => $rec->file])); ?>" class="btn btn-primary">afficher le contenu </a>
    <?php endif; ?>
  </div>
  </div>
  <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\reclamation_stage_part2\reclamation_stage_part1\reclamation_stage\resources\views/supervisor/conv.blade.php ENDPATH**/ ?>