...
<script>
  $(document).ready(function() {
    ...
    $.each(response, function(index, reclamation) {
        ...
        html += '<a href="<?php echo e(route('rec', $reclamation)); ?>" class="btn btn-primary">Voir les détails</a>';
...
</html><?php /**PATH C:\xampp1\htdocs\save_project\reclamation_stage\resources\views/supervisor/non_traiter.blade.php ENDPATH**/ ?>