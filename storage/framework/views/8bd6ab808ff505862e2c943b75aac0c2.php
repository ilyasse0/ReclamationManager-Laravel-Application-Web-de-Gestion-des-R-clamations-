  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
	        ...
	        <ul class="list-unstyled components mb-5">
	          <li class="active">
	            <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Mes réclamation</a>
	          </li>
            ...
            <li class="">
	            <a href="#homeSubmenu" data-toggle="" aria-expanded="true" class="dropdown-toggle">Ajouter une réclamation</a>
	          </li>
...
<a href="#" data-toggle="modal" class="btn btn-primary" data-target="#exampleModal">Créer une réclamation</a>


  <div class="card-head d-flex justify-content-between">
    <h5 class="mb-4">Vos réclamations</h5>
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    ...
    <script src="side_bar/js/jquery.min.js"></script>
    <script src="side_bar/js/popper.js"></script>
    <script src="side_bar/js/bootstrap.min.js"></script>
    <script src="side_bar/js/main.js"></script>
  </body>
